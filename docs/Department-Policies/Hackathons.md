...
!!! Example "All-department hackathons"
...
Use the Hackathon Proposal template, found in the [Proposals library in SharePoint](https://adammatthewdigital.sharepoint.com/sites/Technology/Proposals/).  
